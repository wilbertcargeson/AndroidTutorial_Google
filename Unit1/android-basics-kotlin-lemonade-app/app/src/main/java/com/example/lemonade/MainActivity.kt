    ...
    private fun setViewElements() {
        ...
        when (lemonadeState) {
            ...
            RESTART -> {
                ...
                image.contentDescription = getString(R.string.lemon_empty_glass)
